...
export class UsersResolver {
    ...
    async findById(@Args() userProfileInput: UserProfileInput): Promise<UserProfileOutput> {
    ...
    async editPersonalProfile(
        ...
        return this.usersService.editPersonalProfile(authUser, editPersonalProfileInput);
    }
    ...
    async editPrivateProfile(
        ...
        return this.usersService.editPrivateProfile(authUser, editPrivateProfileInput);
    }

    @Mutation((returns) => FollowFriendOutput)
    async followFriend(
        @AuthUser() authUser: User,
	...
	@Query(returns => FollowingFriendsOutput)
